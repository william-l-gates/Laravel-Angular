...
//Order Details
    ...
    Route::get('/order/channel/{id}',       'OrderController@channel');
...
//shipment Details
    ...
    Route::get('/shipment/channel/{id}',       'ShipmentController@channel');
    Route::get(' /shipment/status/{id}',       'ShipmentController@status');
//Direct Shipment
